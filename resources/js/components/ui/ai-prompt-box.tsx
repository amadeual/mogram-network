...
// Helper for Tailwind merge (simplified for this task)
...
// Inject styles into document (if running in browser)
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    ...
    const sizeClasses = {
      ...
      sm: "h-8 px-3 text-sm",
      lg: "h-12 px-6",
      icon: "h-8 w-8 rounded-full aspect-[1/1] flex items-center justify-center",
    };
    return (
      <button
        className={cn(
...
const CustomDivider: React.FC = () => (
  <div className="relative h-6 w-[1.5px] mx-1">
    <div
      className="absolute inset-0 bg-gradient-to-t from-transparent via-purple-500/70 to-transparent rounded-full"
      style={{
...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Diga algo para a comunidade...", className } = props;
