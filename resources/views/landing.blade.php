...
<section style="padding: 5rem 0 10rem; background: #0b0a15;">
    <div class="container">
        ...
        <div class="creators-grid">
            @php
                $demoCreators = [
                    ['name' => 'Isabella Costa', 'handle' => '@isabella_fit', 'fans' => '12.4K', 'img' => 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80'],
                    ...
                    ['name' => 'Valeska Rippert', 'handle' => '@valeska.rippert', 'fans' => '25.7K', 'img' => 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80'],
            ...
            <div class="creator-card-social" style="background: rgba(255,255,255,0.03); padding: 2rem; border-radius: 30px; border: 1px solid rgba(255,255,255,0.05); text-align: center; transition: 0.3s; cursor: pointer;">
                <div style="position: relative; width: 100px; height: 100px; margin: 0 auto 1.5rem;">
                    <img src="{{ $creator['img'] }}" style="width: 100%; height: 100%; border-radius: 50%; border: 3px solid #ff4b1f; padding: 4px; object-fit: cover;">
