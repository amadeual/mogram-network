<aside class="sidebar" style="background: #0f111a; border-right: 1px solid rgba(255,255,255,0.05); display: flex; flex-direction: column;">
    <a href="{{ route('studio.settings') }}" style="text-decoration: none; padding: 2rem 1.5rem; display: flex; align-items: center; gap: 1rem; border-bottom: 1px solid rgba(255,255,255,0.03); transition: 0.3s;" onmouseover="this.style.background='rgba(255,255,255,0.02)'" onmouseout="this.style.background='transparent'">
        @if(Auth::user()->avatar)
    ...
    <nav style="display: flex; flex-direction: column; gap: 0.25rem; padding: 1rem 0.75rem;">
        <a href="{{ route('dashboard') }}" class="menu-item" style="padding: 0.875rem 1rem; color: #a855f7; border-bottom: 1px solid rgba(255,255,255,0.05); margin-bottom: 0.5rem;">
        ...
        <a href="{{ route('studio.dashboard') }}" class="menu-item {{ Route::is('studio.dashboard') ? 'active' : '' }}" style="padding: 0.875rem 1rem;">
        ...
        <a href="{{ route('studio.content') }}" class="menu-item {{ Route::is('studio.content') ? 'active' : '' }}" style="padding: 0.875rem 1rem;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
            Conteúdo
        </a>
        <a href="{{ route('studio.analytics') }}" class="menu-item {{ Route::is('studio.analytics') ? 'active' : '' }}" style="padding: 0.875rem 1rem;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
            Analytics
        </a>
        <a href="{{ route('studio.finance') }}" class="menu-item {{ Route::is('studio.finance') ? 'active' : '' }}" style="padding: 0.875rem 1rem;">
        ...
        <a href="{{ route('studio.settings') }}" class="menu-item {{ Route::is('studio.settings') ? 'active' : '' }}" style="padding: 0.875rem 1rem;">
