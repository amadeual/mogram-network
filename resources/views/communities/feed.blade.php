    ...
    <main class="main-content">
        ...
        <div style="margin-top: 4rem; display: grid; grid-template-columns: 1fr 300px; gap: 2rem; padding: 0 2rem 5rem;">
            ...
            <div class="community-feed">
                ...
                <!-- Feed Filters (Mocking for now as per Image 4) -->
                <div style="display: flex; gap: 1rem; margin-bottom: 2rem; overflow-x: auto; padding-bottom: 0.5rem; scrollbar-width: none;">
                    <button class="filter-tab active" style="background: #3390ec; border: none; color: white; padding: 8px 20px; border-radius: 10px; font-size: 12px; font-weight: 800; white-space: nowrap; cursor: pointer;">Todos</button>
                    <button class="filter-tab" style="background: rgba(255,255,255,0.03); border: none; color: var(--text-muted); padding: 8px 20px; border-radius: 10px; font-size: 12px; font-weight: 800; white-space: nowrap; cursor: pointer;">Vídeos</button>
                    <button class="filter-tab" style="background: rgba(255,255,255,0.03); border: none; color: var(--text-muted); padding: 8px 20px; border-radius: 10px; font-size: 12px; font-weight: 800; white-space: nowrap; cursor: pointer;">Fotos</button>
                    <button class="filter-tab" style="background: rgba(255,255,255,0.03); border: none; color: var(--text-muted); padding: 8px 20px; border-radius: 10px; font-size: 12px; font-weight: 800; white-space: nowrap; cursor: pointer;">Cursos</button>
                    <button class="filter-tab" style="background: rgba(255,255,255,0.03); border: none; color: var(--text-muted); padding: 8px 20px; border-radius: 10px; font-size: 12px; font-weight: 800; white-space: nowrap; cursor: pointer;">Planilhas</button>
                </div>
