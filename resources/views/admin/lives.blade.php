...
<style>
    ...
    .pagination a, .pagination span { border-color: var(--border-gray) !important; background: rgba(255,255,255,0.03) !important; color: white !important; }
            ...
            <tr style="border-bottom: 1px solid var(--border-gray); transition: 0.2s;" onmouseover="this.style.background='rgba(51, 144, 236, 0.02)'" onmouseout="this.style.background='transparent'">
                ...
                <td style="padding: 1.5rem 2rem; text-align: right;">
                    <div style="display: flex; justify-content: flex-end; gap: 10px;">
                        ...
                        <form action="{{ route('admin.content.delete_live', $live->id) }}" method="POST" onsubmit="confirmDelete(event, this, 'Remover esta live permanentemente do sistema?')">
                            @csrf
                            @method('DELETE')
