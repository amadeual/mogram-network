...
<form action="{{ route('admin.help.store') }}" method="POST" enctype="multipart/form-data" id="help-form" class="admin-card" style="max-width: 800px;">
    ...
    <div style="margin-bottom: 2rem;">
        ...
        <div id="editor" style="height: 350px; background: rgba(255,255,255,0.02); border: 1.5px solid rgba(255,255,255,0.08); border-radius: 12px; color: white; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px;"></div>
