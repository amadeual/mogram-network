...
@section('title', 'Novo Artigo de Ajuda')

@section('admin_content')
<div style="margin-bottom: 3rem;">
    <p style="color: var(--primary-blue); font-size: 0.8rem; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 0.5rem;">Home / Central de Ajuda / Novo</p>
...
<form action="{{ route('admin.help.store') }}" method="POST" enctype="multipart/form-data" class="admin-card" style="max-width: 800px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
        <div>
            ...
            <input type="text" name="title" required value="{{ old('title') }}" placeholder="Ex: Como postar conteúdo" style="width: 100%; background: rgba(255,255,255,0.03); border: 1.5px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 12px 15px; color: white; font-weight: 600; outline: none; transition: 0.2s;" onfocus="this.style.borderColor='var(--primary-blue)'" onblur="this.style.borderColor='rgba(255,255,255,0.08)'">
        </div>
        <div>
            ...
            <select name="category" required style="width: 100%; background: #11141e; border: 1.5px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 12px 15px; color: white; font-weight: 600; outline: none;">
                ...
                <option value="Conteúdo e Studio">Conteúdo e Studio</option>
                <option value="Comunidades">Comunidades</option>
                <option value="Financeiro e Ganhos">Financeiro e Ganhos</option>
                <option value="Dicas Pro">Dicas Pro</option>
            </select>
        </div>
    </div>
    ...
    <div style="margin-bottom: 1.5rem;">
        ...
        <textarea name="description" rows="2" style="width: 100%; background: rgba(255,255,255,0.03); border: 1.5px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 12px 15px; color: white; font-weight: 600; outline: none; resize: none;">{{ old('description') }}</textarea>
    </div>
    ...
    <div style="margin-bottom: 1.5rem;">
        ...
        <textarea name="content" rows="10" required style="width: 100%; background: rgba(255,255,255,0.03); border: 1.5px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 12px 15px; color: white; font-weight: 600; outline: none; font-family: monospace;">{{ old('content') }}</textarea>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
        ...
        <div>
            ...
            <div style="display: flex; gap: 1rem; align-items: center;">
                <input type="number" name="order" value="0" style="width: 80px; background: rgba(255,255,255,0.03); border: 1.5px solid rgba(255,255,255,0.08); border-radius: 12px; padding: 12px 15px; color: white; font-weight: 600; outline: none;">
                <label style="display: flex; align-items: center; gap: 8px; color: white; font-weight: 700; cursor: pointer;">
                    <input type="checkbox" name="is_active" checked style="width: 18px; height: 18px; accent-color: var(--primary-blue);"> Ativo
                </label>
            </div>
        </div>
    </div>
    ...
    <div style="display: flex; gap: 1rem; padding-top: 1.5rem; border-top: 1px solid var(--border-gray);">
        <button type="submit" class="btn-primary" style="padding: 12px 40px;">Salvar Artigo</button>
